...
def _draw_and_save_output_image(image_path, detections, img_size, output_path, classes):
    ...
    for x1, y1, x2, y2, conf, cls_pred in detections:
        # print(cls_pred)
        print(f"t+ Label: {classes[int(cls_pred)]} | Confidence: {conf.item():0.4f}")
...
def run():
    ...
    # parser.add_argument("-i", "--images", type=str, default="data_yolo/samples", help="Path to directory with images to inference")
    # parser.add_argument("-c", "--classes", type=str, default="data_yolo/coco.names", help="Path to classes label file (.names)")
    ...
    args.model = "config/dota-yolov3-416.cfg"
    args.img_size = 608
    args.weights = "DOTA/dota-yolov3-416_150000.weights"
    args.images = "DOTA/train/test_img"
    args.classes = "DOTA/dota.names"
